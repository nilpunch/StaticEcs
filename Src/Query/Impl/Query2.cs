...
namespace FFS.Libraries.StaticEcs {
    ...
    public abstract partial class World<TWorld> {
        #region ADAPTERS
        internal interface IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {

            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1);

            public void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1);
        }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionStructAdapter<T0, T1, TFunction> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent
            ...
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function.Invoke(entity, ref comp0, ref comp1);
            }
            ...
            public void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                ...
                while (start < end) {
                    ...
                    #endif
                    Function.Invoke(entity, ref comp0[start], ref comp1[start]);
                    start++;
                    entityId++;
                }
            }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionAdapter<T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public QueryFunction<T0, T1> Function;

            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function(ref comp0, ref comp1);
            }
            ...
            public void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                while (start < end) {
                    ...
                    Data.Instance.SetCurrentQueryEntity(entity.IdWithOffset++);
                    #endif
                    Function.Invoke(ref comp0[start], ref comp1[start]);
                    start++;
                }
            }
        }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionWithEntityAdapter<T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public QueryFunctionWithEntity<TWorld, T0, T1> Function;

            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function(entity, ref comp0, ref comp1);
            }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionWithDataEntityAdapter<TData, T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public QueryFunctionWithRefDataEntity<TData, TWorld, T0, T1> Function;
            public TData UserData;

            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function(ref UserData, entity, ref comp0, ref comp1);
            }
            ...
            public void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                ...
                while (start < end) {
                    ...
                    Data.Instance.SetCurrentQueryEntity(entity.IdWithOffset);
                    #endif
                    Function.Invoke(ref UserData, entity, ref comp0[start], ref comp1[start]);
                    start++;
                    entityId++;
                }
            }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionWithDataAdapter<TData, T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public QueryFunctionWithRefData<TData, T0, T1> Function;
            public TData UserData;

            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function(ref UserData, ref comp0, ref comp1);
            }
            ...
            public void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                while (start < end) {
                    ...
                    Data.Instance.SetCurrentQueryEntity(entity.IdWithOffset++);
                    #endif
                    Function.Invoke(ref UserData, ref comp0[start], ref comp1[start]);
                    start++;
                }
            }
        }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryUnsafeFunctionAdapter<T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public unsafe delegate*<ref T0, ref T1, void> Function;

            [MethodImpl(AggressiveInlining)]
            public unsafe void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function(ref comp0, ref comp1);
            }

            [MethodImpl(AggressiveInlining)]
            public unsafe void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                while (start < end) {
                    #if FFS_ECS_DEBUG
                    Data.Instance.SetCurrentQueryEntity(entity.IdWithOffset++);
                    #endif
                    Function(ref comp0[start], ref comp1[start]);
                    start++;
                }
            }
        }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryUnsafeFunctionWithEntityAdapter<T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public unsafe delegate*<Entity, ref T0, ref T1, void> Function;
            ...
            public unsafe void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                ...
                while (start < end) {
                    ...
                    Data.Instance.SetCurrentQueryEntity(entity.IdWithOffset);
                    #endif
                    Function(entity, ref comp0[start], ref comp1[start]);
                    start++;
                    entityId++;
                }
            }
        ...
        // ---- Write1Read1 — T1 is in ----
        #if ENABLE_IL2CPP
        [Il2CppSetOption(Option.NullChecks, Const.IL2CPPNullChecks)]
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionStructAdapterW1R1<T0, T1, TFunction> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent
            ...
            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function.Invoke(entity, ref comp0, in comp1);
            }
            ...
            public void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                ...
                while (start < end) {
                    ...
                    Data.Instance.SetCurrentQueryEntity(entity.IdWithOffset);
                    #endif
                    Function.Invoke(entity, ref comp0[start], in comp1[start]);
                    start++;
                    entityId++;
                }
            }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionAdapterWrite1Read1<T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public QueryFunctionR1<T0, T1> Function;

            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function(ref comp0, in comp1);
            }
            ...
            public void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                while (start < end) {
                    ...
                    Data.Instance.SetCurrentQueryEntity(entity.IdWithOffset++);
                    #endif
                    Function.Invoke(ref comp0[start], in comp1[start]);
                    start++;
                }
            }
        }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionWithEntityAdapterWrite1Read1<T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public QueryFunctionWithEntityR1<TWorld, T0, T1> Function;

            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function(entity, ref comp0, in comp1);
            }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionWithDataEntityAdapterWrite1Read1<TData, T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public QueryFunctionWithRefDataEntityR1<TData, TWorld, T0, T1> Function;
            public TData UserData;

            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function(ref UserData, entity, ref comp0, in comp1);
            }
            ...
            public void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                ...
                while (start < end) {
                    ...
                    Data.Instance.SetCurrentQueryEntity(entity.IdWithOffset);
                    #endif
                    Function.Invoke(ref UserData, entity, ref comp0[start], in comp1[start]);
                    start++;
                    entityId++;
                }
            }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionWithDataAdapterWrite1Read1<TData, T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public QueryFunctionWithRefDataR1<TData, T0, T1> Function;
            public TData UserData;

            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function(ref UserData, ref comp0, in comp1);
            }
            ...
            public void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                while (start < end) {
                    ...
                    Data.Instance.SetCurrentQueryEntity(entity.IdWithOffset++);
                    #endif
                    Function.Invoke(ref UserData, ref comp0[start], in comp1[start]);
                    start++;
                }
            }
        }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionStructAdapterRead<T0, T1, TFunction> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent
            ...
            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function.Invoke(entity, in comp0, in comp1);
            }
            ...
            public void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                ...
                while (start < end) {
                    ...
                    Data.Instance.SetCurrentQueryEntity(entity.IdWithOffset);
                    #endif
                    Function.Invoke(entity, in comp0[start], in comp1[start]);
                    start++;
                    entityId++;
                }
            }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionAdapterRead<T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public QueryFunctionR2<T0, T1> Function;

            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function(in comp0, in comp1);
            }
            ...
            public void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                while (start < end) {
                    ...
                    Data.Instance.SetCurrentQueryEntity(entity.IdWithOffset++);
                    #endif
                    Function.Invoke(in comp0[start], in comp1[start]);
                    start++;
                }
            }
        }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionWithEntityAdapterRead<T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public QueryFunctionWithEntityR2<TWorld, T0, T1> Function;

            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function(entity, in comp0, in comp1);
            }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionWithDataEntityAdapterRead<TData, T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public QueryFunctionWithRefDataEntityR2<TData, TWorld, T0, T1> Function;
            public TData UserData;

            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function(ref UserData, entity, in comp0, in comp1);
            }
            ...
            public void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                ...
                while (start < end) {
                    ...
                    Data.Instance.SetCurrentQueryEntity(entity.IdWithOffset);
                    #endif
                    Function.Invoke(ref UserData, entity, in comp0[start], in comp1[start]);
                    start++;
                    entityId++;
                }
            }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct QueryFunctionWithDataAdapterRead<TData, T0, T1> : IQueryFunctionAdapter<T0, T1>
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
            public QueryFunctionWithRefDataR2<TData, T0, T1> Function;
            public TData UserData;

            [MethodImpl(AggressiveInlining)]
            public void Invoke(Entity entity, ref T0 comp0, ref T1 comp1) {
                Function(ref UserData, in comp0, in comp1);
            }
            ...
            public void InvokeBlock(Entity entity, uint start, uint end, T0[] comp0, T1[] comp1) {
                while (start < end) {
                    ...
                    Data.Instance.SetCurrentQueryEntity(entity.IdWithOffset++);
                    #endif
                    Function.Invoke(ref UserData, in comp0[start], in comp1[start]);
                    start++;
                }
            }
        }
        ...
        // ---- Block adapters ----
        internal interface IBlockQueryAdapter<T0, T1>
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct BlockAdapterWrite<T0, T1, TFunction> : IBlockQueryAdapter<T0, T1>
                where T0 : unmanaged, IComponent
                where T1 : unmanaged, IComponent
            ...
            [MethodImpl(AggressiveInlining)]
            public void Invoke(uint count, EntityBlock entitiesBlock, Block<T0> block0, Block<T1> block1) {
                Function.Invoke(count, entitiesBlock, block0, block1);
            }
        }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct BlockUnsafeAdapter<T0, T1> : IBlockQueryAdapter<T0, T1>
                where T0 : unmanaged, IComponent
                where T1 : unmanaged, IComponent {
            public unsafe delegate*<uint, EntityBlock, Block<T0>, Block<T1>, void> Function;

            [MethodImpl(AggressiveInlining)]
            public unsafe void Invoke(uint count, EntityBlock entitiesBlock, Block<T0> block0, Block<T1> block1) {
                Function(count, entitiesBlock, block0, block1);
            }
        }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct BlockAdapterW1R1<T0, T1, TFunction> : IBlockQueryAdapter<T0, T1>
                where T0 : unmanaged, IComponent
                where T1 : unmanaged, IComponent
            ...
            [MethodImpl(AggressiveInlining)]
            public void Invoke(uint count, EntityBlock entitiesBlock, Block<T0> block0, Block<T1> block1) {
                Function.Invoke(count, entitiesBlock, block0, new BlockR<T1>(block1));
            }
        }
        ...
        [Il2CppSetOption(Option.ArrayBoundsChecks, Const.IL2CPPArrayBoundsChecks)]
        #endif
        internal struct BlockAdapterRead<T0, T1, TFunction> : IBlockQueryAdapter<T0, T1>
                where T0 : unmanaged, IComponent
                where T1 : unmanaged, IComponent
            ...
            [MethodImpl(AggressiveInlining)]
            public void Invoke(uint count, EntityBlock entitiesBlock, Block<T0> block0, Block<T1> block1) {
                Function.Invoke(count, entitiesBlock, new BlockR<T0>(block0), new BlockR<T1>(block1));
            }
        }
        
        #endif // !FFS_ECS_DISABLE_CHANGED_TRACKING
        #endregion
        /// <summary>Fluent query builder for 2 writable component(s). Call <c>For</c>/<c>ForParallel</c> to execute.</summary>
        public readonly struct WriteQuery<TFilter, T0, T1>
            where T0 : struct, IComponent
            where T1 : struct, IComponent
            ...
            public void ForParallel<TFunction>(ref TFunction function,
                ...
                if (new WorldQuery<TFilter>(Filter).PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&WorldQuery<TFilter>.ForParallelInternal<T0, T1, QueryFunctionStructAdapter<T0, T1, TFunction>>,
            ...
            #if !FFS_ECS_DISABLE_CHANGED_TRACKING
            /// <summary>Fluent query builder for 2 writable and 1 readonly component(s). Call <c>For</c>/<c>ForParallel</c> to execute.</summary>
            public readonly struct ReadQuery<T2>
                ...
                public void ForParallel<TFunction>(ref TFunction function,
                    ...
                    if (new WorldQuery<TFilter>(Filter).PrepareParallel<T0, T1, T2>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                        ...
                        {
                            unsafe {
                                ParallelRunner<TWorld>.Run(&WorldQuery<TFilter>.ForParallelInternal<T0, T1, T2, QueryFunctionStructAdapterW2R1<T0, T1, T2, TFunction>>,
                                    jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                                );
                            }
                        }
            ...
            /// <summary>Fluent query builder for 2 writable and 2 readonly component(s). Call <c>For</c>/<c>ForParallel</c> to execute.</summary>
            public readonly struct ReadQuery<T2, T3>
                where T2 : struct, IComponent
                ...
                public void ForParallel<TFunction>(ref TFunction function,
                    ...
                    if (new WorldQuery<TFilter>(Filter).PrepareParallel<T0, T1, T2, T3>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                        ...
                        {
                            unsafe {
                                ParallelRunner<TWorld>.Run(&WorldQuery<TFilter>.ForParallelInternal<T0, T1, T2, T3, QueryFunctionStructAdapterW2R2<T0, T1, T2, T3, TFunction>>,
                                    jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                                );
                            }
                        }
            ...
            /// <summary>Fluent query builder for 2 writable and 3 readonly component(s). Call <c>For</c>/<c>ForParallel</c> to execute.</summary>
            public readonly struct ReadQuery<T2, T3, T4>
                where T2 : struct, IComponent
                where T3 : struct, IComponent
                ...
                public void ForParallel<TFunction>(ref TFunction function,
                    ...
                    if (new WorldQuery<TFilter>(Filter).PrepareParallel<T0, T1, T2, T3, T4>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                        ...
                        {
                            unsafe {
                                ParallelRunner<TWorld>.Run(&WorldQuery<TFilter>.ForParallelInternal<T0, T1, T2, T3, T4, QueryFunctionStructAdapterW2R3<T0, T1, T2, T3, T4, TFunction>>,
                                    jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                                );
                            }
                        }
            ...
            /// <summary>Fluent query builder for 2 writable and 4 readonly component(s). Call <c>For</c>/<c>ForParallel</c> to execute.</summary>
            public readonly struct ReadQuery<T2, T3, T4, T5>
                where T2 : struct, IComponent
                where T3 : struct, IComponent
                where T4 : struct, IComponent
                ...
                public void ForParallel<TFunction>(ref TFunction function,
                    ...
                    if (new WorldQuery<TFilter>(Filter).PrepareParallel<T0, T1, T2, T3, T4, T5>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                        ...
                        {
                            unsafe {
                                ParallelRunner<TWorld>.Run(&WorldQuery<TFilter>.ForParallelInternal<T0, T1, T2, T3, T4, T5, QueryFunctionStructAdapterW2R4<T0, T1, T2, T3, T4, T5, TFunction>>,
                                    jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                                );
                            }
                        }
            ...
            [MethodImpl(AggressiveInlining)]
            public ReadQuery<T2> Read<T2>() where T2 : struct, IComponent {
                return new ReadQuery<T2>(Filter);
            }

            /// <summary>Adds 2 readonly component(s) to the query, creating a mixed write/read query.</summary>
            [MethodImpl(AggressiveInlining)]
            public ReadQuery<T2, T3> Read<T2, T3>() where T2 : struct, IComponent where T3 : struct, IComponent {
                return new ReadQuery<T2, T3>(Filter);
            }

            /// <summary>Adds 3 readonly component(s) to the query, creating a mixed write/read query.</summary>
            [MethodImpl(AggressiveInlining)]
            public ReadQuery<T2, T3, T4> Read<T2, T3, T4>() where T2 : struct, IComponent where T3 : struct, IComponent where T4 : struct, IComponent {
                return new ReadQuery<T2, T3, T4>(Filter);
            }

            /// <summary>Adds 4 readonly component(s) to the query, creating a mixed write/read query.</summary>
            [MethodImpl(AggressiveInlining)]
            public ReadQuery<T2, T3, T4, T5> Read<T2, T3, T4, T5>() where T2 : struct, IComponent where T3 : struct, IComponent where T4 : struct, IComponent where T5 : struct, IComponent {
                return new ReadQuery<T2, T3, T4, T5>(Filter);
            }
        ...
        #if !FFS_ECS_DISABLE_CHANGED_TRACKING
        /// <summary>Fluent query builder for 2 readonly component(s). Call <c>For</c>/<c>ForParallel</c> to execute.</summary>
        public readonly struct ReadQuery<TFilter, T0, T1>
            where T0 : struct, IComponent
            where T1 : struct, IComponent
            where TFilter : struct, IQueryFilter {
            internal readonly TFilter Filter;
            ...
            public void For<TFunction>(TFunction function = default,
                                       ...
                                       ReadOnlySpan<ushort> clusters = default)
                where TFunction : struct, IQuery.Read<T0, T1> {
                QueryFunctionStructAdapterRead<T0, T1, TFunction> adapter;
                adapter.Function = function;
                new WorldQuery<TFilter>(Filter).ForInternal<T0, T1, QueryFunctionStructAdapterRead<T0, T1, TFunction>>(ref adapter, entities, components, queryMode, clusters);
            }
            ...
            public void ForParallel<TFunction>(ref TFunction function,
                ...
                if (new WorldQuery<TFilter>(Filter).PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&WorldQuery<TFilter>.ForParallelInternal<T0, T1, QueryFunctionStructAdapterRead<T0, T1, TFunction>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
        ...
        #endif // !FFS_ECS_DISABLE_CHANGED_TRACKING
        /// <summary>Fluent block query builder for 2 writable component(s). Call <c>For</c>/<c>ForParallel</c> to execute.</summary>
        public readonly struct BlockWriteQuery<TFilter, T0, T1>
            where T0 : unmanaged, IComponent
            where T1 : unmanaged, IComponent
            where TFilter : struct, IQueryFilter {
            internal readonly TFilter Filter;
            ...
            public void ForParallel<TFunction>(ref TFunction function,
                ...
                if (new WorldQuery<TFilter>(Filter).PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&WorldQuery<TFilter>.ForBlockParallelInternal<T0, T1, BlockAdapterWrite<T0, T1, TFunction>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
            ...
            public readonly struct ReadQuery<T2>
                ...
                public void ForParallel<TFunction>(ref TFunction function,
                    ...
                    if (new WorldQuery<TFilter>(Filter).PrepareParallel<T0, T1, T2>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                        ...
                        {
                            unsafe {
                                ParallelRunner<TWorld>.Run(&WorldQuery<TFilter>.ForBlockParallelInternal<T0, T1, T2, BlockAdapterW2R1<T0, T1, T2, TFunction>>,
                                    jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                                );
                            }
                        }
            ...
            public readonly struct ReadQuery<T2, T3>
                ...
                public void For<TFunction>(TFunction function = default,
                    ...
                    BlockAdapterW2R2<T0, T1, T2, T3, TFunction> adapter;
                    adapter.Function = function;
                ...
                public void ForParallel<TFunction>(ref TFunction function,
                    ...
                    if (new WorldQuery<TFilter>(Filter).PrepareParallel<T0, T1, T2, T3>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                        ...
                        {
                            unsafe {
                                ParallelRunner<TWorld>.Run(&WorldQuery<TFilter>.ForBlockParallelInternal<T0, T1, T2, T3, BlockAdapterW2R2<T0, T1, T2, T3, TFunction>>,
                                    jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                                );
                            }
                        }
            ...
            public readonly struct ReadQuery<T2, T3, T4>
                ...
                public void For<TFunction>(TFunction function = default,
                    ...
                    BlockAdapterW2R3<T0, T1, T2, T3, T4, TFunction> adapter;
                    adapter.Function = function;
                ...
                public void ForParallel<TFunction>(ref TFunction function,
                    ...
                    if (new WorldQuery<TFilter>(Filter).PrepareParallel<T0, T1, T2, T3, T4>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                        ...
                        {
                            unsafe {
                                ParallelRunner<TWorld>.Run(&WorldQuery<TFilter>.ForBlockParallelInternal<T0, T1, T2, T3, T4, BlockAdapterW2R3<T0, T1, T2, T3, T4, TFunction>>,
                                    jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                                );
                            }
                        }
            ...
            public readonly struct ReadQuery<T2, T3, T4, T5>
                ...
                public void For<TFunction>(TFunction function = default,
                    ...
                    BlockAdapterW2R4<T0, T1, T2, T3, T4, T5, TFunction> adapter;
                    adapter.Function = function;
                ...
                public void ForParallel<TFunction>(ref TFunction function,
                    ...
                    if (new WorldQuery<TFilter>(Filter).PrepareParallel<T0, T1, T2, T3, T4, T5>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                        ...
                        {
                            unsafe {
                                ParallelRunner<TWorld>.Run(&WorldQuery<TFilter>.ForBlockParallelInternal<T0, T1, T2, T3, T4, T5, BlockAdapterW2R4<T0, T1, T2, T3, T4, T5, TFunction>>,
                                    jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                                );
                            }
                        }
            ...
            /// <summary>Adds 1 readonly component(s) to the query, creating a mixed write/read query.</summary>
            [MethodImpl(AggressiveInlining)]
            public ReadQuery<T2> Read<T2>() where T2 : unmanaged, IComponent {
                return new ReadQuery<T2>(Filter);
            }

            /// <summary>Adds 2 readonly component(s) to the query, creating a mixed write/read query.</summary>
            [MethodImpl(AggressiveInlining)]
            public ReadQuery<T2, T3> Read<T2, T3>() where T2 : unmanaged, IComponent where T3 : unmanaged, IComponent {
                return new ReadQuery<T2, T3>(Filter);
            }

            /// <summary>Adds 3 readonly component(s) to the query, creating a mixed write/read query.</summary>
            [MethodImpl(AggressiveInlining)]
            public ReadQuery<T2, T3, T4> Read<T2, T3, T4>() where T2 : unmanaged, IComponent where T3 : unmanaged, IComponent where T4 : unmanaged, IComponent {
                return new ReadQuery<T2, T3, T4>(Filter);
            }

            /// <summary>Adds 4 readonly component(s) to the query, creating a mixed write/read query.</summary>
            [MethodImpl(AggressiveInlining)]
            public ReadQuery<T2, T3, T4, T5> Read<T2, T3, T4, T5>() where T2 : unmanaged, IComponent where T3 : unmanaged, IComponent where T4 : unmanaged, IComponent where T5 : unmanaged, IComponent {
                return new ReadQuery<T2, T3, T4, T5>(Filter);
            }
        ...
        #if !FFS_ECS_DISABLE_CHANGED_TRACKING
        /// <summary>Fluent block query builder for 2 readonly component(s). Call <c>For</c>/<c>ForParallel</c> to execute.</summary>
        public readonly struct BlockReadQuery<TFilter, T0, T1>
            where T0 : unmanaged, IComponent
            where T1 : unmanaged, IComponent
            where TFilter : struct, IQueryFilter {
            internal readonly TFilter Filter;
            ...
            public void For<TFunction>(TFunction function = default,
                                       ...
                                       ReadOnlySpan<ushort> clusters = default)
                where TFunction : struct, IQueryBlock.Read<T0, T1> {
                BlockAdapterRead<T0, T1, TFunction> adapter;
                adapter.Function = function;
                new WorldQuery<TFilter>(Filter).ForBlockInternal<T0, T1, BlockAdapterRead<T0, T1, TFunction>>(ref adapter,
                    entities, components, clusters);
            }
            ...
            public void ForParallel<TFunction>(ref TFunction function,
                ...
                if (new WorldQuery<TFilter>(Filter).PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&WorldQuery<TFilter>.ForBlockParallelInternal<T0, T1, BlockAdapterRead<T0, T1, TFunction>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
        ...
        public readonly ref partial struct WorldQuery<TFilter> where TFilter : struct, IQueryFilter {
            ...
            /// <summary>Creates a query builder for 2 writable component(s).</summary>
            [MethodImpl(AggressiveInlining)]
            public WriteQuery<TFilter, T0, T1> Write<T0, T1>()
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
                return new WriteQuery<TFilter, T0, T1>(Filter);
            }

            #if !FFS_ECS_DISABLE_CHANGED_TRACKING
            /// <summary>Creates a query builder for 2 readonly component(s).</summary>
            [MethodImpl(AggressiveInlining)]
            public ReadQuery<TFilter, T0, T1> Read<T0, T1>()
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
                return new ReadQuery<TFilter, T0, T1>(Filter);
            }
            #endif // !FFS_ECS_DISABLE_CHANGED_TRACKING

            /// <summary>Creates a block query builder for 2 writable component(s).</summary>
            [MethodImpl(AggressiveInlining)]
            public BlockWriteQuery<TFilter, T0, T1> WriteBlock<T0, T1>()
                where T0 : unmanaged, IComponent
                where T1 : unmanaged, IComponent {
                return new BlockWriteQuery<TFilter, T0, T1>(Filter);
            }

            #if !FFS_ECS_DISABLE_CHANGED_TRACKING
            /// <summary>Creates a block query builder for 2 readonly component(s).</summary>
            [MethodImpl(AggressiveInlining)]
            public BlockReadQuery<TFilter, T0, T1> ReadBlock<T0, T1>()
                where T0 : unmanaged, IComponent
                where T1 : unmanaged, IComponent {
                return new BlockReadQuery<TFilter, T0, T1>(Filter);
            }
            #endif // !FFS_ECS_DISABLE_CHANGED_TRACKING
            ...
            internal bool SearchStrict<T0, T1>(out Entity entity,
                ...
                if (PrepareStrict<T0, T1>(Filter, clusters, entities, components, out var queryData, out var firstGlobalBlockIdx)) {
                    ...
                    #endif
                    {
                        Data.Instance.PopCurrentQuery(queryData);
                        #if FFS_ECS_DEBUG
                        DisposeStrict<T0, T1>(Filter, entities, components, queryData);
                        #endif
                    }
                }
            ...
            /// </summary>
            [MethodImpl(AggressiveInlining)]
            public void For<TData, T0, T1>(TData userData,
                                           QueryFunctionWithRefDataEntity<TData, TWorld, T0, T1> function,
                                           EntityStatusType entities = EntityStatusType.Enabled,
                                           ComponentStatus components = ComponentStatus.Enabled,
                                           QueryMode queryMode = QueryMode.Strict,
                                           ReadOnlySpan<ushort> clusters = default)
                ...
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
                QueryFunctionWithDataEntityAdapter<TData, T0, T1> adapter;
                adapter.Function = function;
            ...
            [MethodImpl(AggressiveInlining)]
            public void For<TData, T0, T1>(ref TData userData,
                                           QueryFunctionWithRefDataEntity<TData, TWorld, T0, T1> function,
                                           EntityStatusType entities = EntityStatusType.Enabled,
                                           ComponentStatus components = ComponentStatus.Enabled,
                                           QueryMode queryMode = QueryMode.Strict,
            ...
            /// </summary>
            [MethodImpl(AggressiveInlining)]
            public void ForParallel<TData, T0, T1>(TData userData,
                                                   QueryFunctionWithRefDataEntity<TData, TWorld, T0, T1> function,
                                                   EntityStatusType entities = EntityStatusType.Enabled,
                                                   ComponentStatus components = ComponentStatus.Enabled,
                                                   ReadOnlySpan<ushort> clusters = default,
            ...
            /// <inheritdoc cref="ForParallel{TData,T0, T1}(ref TData, QueryFunctionWithRefDataEntity{TData,TWorld,T0, T1}, EntityStatusType, ComponentStatus, ReadOnlySpan{ushort}, uint, uint)"/>
            [MethodImpl(AggressiveInlining)]
            public void ForParallel<TData, T0, T1>(ref TData userData,
                                                   QueryFunctionWithRefDataEntity<TData, TWorld, T0, T1> function,
                                                   EntityStatusType entities = EntityStatusType.Enabled,
                                                   ComponentStatus components = ComponentStatus.Enabled,
                                                   ReadOnlySpan<ushort> clusters = default,
                ...
                if (PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&ForParallelInternal<T0, T1, QueryFunctionWithDataEntityAdapter<TData, T0, T1>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
            ...
            /// <inheritdoc cref="Search{T0, T1}(out Entity, SearchFunctionWithEntity{TWorld,T0, T1}, EntityStatusType, ComponentStatus, QueryMode, ReadOnlySpan{ushort})"/>
            [MethodImpl(AggressiveInlining)]
            public void For<T0, T1>(QueryFunctionWithEntity<TWorld, T0, T1> function,
                                    EntityStatusType entities = EntityStatusType.Enabled,
                                    ComponentStatus components = ComponentStatus.Enabled,
                                    QueryMode queryMode = QueryMode.Strict,
                                    ReadOnlySpan<ushort> clusters = default)
            ...
            /// <inheritdoc cref="ForParallel{T0, T1}(QueryFunctionWithEntity{TWorld,T0, T1}, EntityStatusType, ComponentStatus, ReadOnlySpan{ushort}, uint, uint)"/>
            [MethodImpl(AggressiveInlining)]
            public void ForParallel<T0, T1>(QueryFunctionWithEntity<TWorld, T0, T1> function,
                                            EntityStatusType entities = EntityStatusType.Enabled,
                                            ComponentStatus components = ComponentStatus.Enabled,
                                            ReadOnlySpan<ushort> clusters = default,
                                            uint minEntitiesPerThread = Const.ENTITIES_IN_SEGMENT,
                ...
                if (PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&ForParallelInternal<T0, T1, QueryFunctionWithEntityAdapter<T0, T1>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
            ...
            [MethodImpl(AggressiveInlining)]
            public void For<TData, T0, T1>(TData userData,
                                           QueryFunctionWithRefData<TData, T0, T1> function,
                                           EntityStatusType entities = EntityStatusType.Enabled,
                                           ComponentStatus components = ComponentStatus.Enabled,
                                           QueryMode queryMode = QueryMode.Strict,
                                           ReadOnlySpan<ushort> clusters = default)
                ...
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
                QueryFunctionWithDataAdapter<TData, T0, T1> adapter;
                adapter.Function = function;
                adapter.UserData = userData;
                #if !FFS_ECS_DISABLE_CHANGED_TRACKING
            ...
            /// <inheritdoc cref="ForParallel{TData,T0, T1}(ref TData, QueryFunctionWithRefData{TData,TWorld,T0, T1}, EntityStatusType, ComponentStatus, ReadOnlySpan{ushort}, uint, uint)"/>
            [MethodImpl(AggressiveInlining)]
            public void ForParallel<TData, T0, T1>(ref TData userData,
                                                   QueryFunctionWithRefData<TData, T0, T1> function,
                                                   EntityStatusType entities = EntityStatusType.Enabled,
                ...
                if (PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&ForParallelInternal<T0, T1, QueryFunctionWithDataAdapter<TData, T0, T1>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
            ...
            [MethodImpl(AggressiveInlining)]
            public void For<T0, T1>(QueryFunction<T0, T1> function,
                                    EntityStatusType entities = EntityStatusType.Enabled,
                                    ComponentStatus components = ComponentStatus.Enabled,
                                    QueryMode queryMode = QueryMode.Strict,
                                    ReadOnlySpan<ushort> clusters = default)
            ...
            /// <inheritdoc cref="ForParallel{T0, T1}(QueryFunction{T0, T1}, EntityStatusType, ComponentStatus, ReadOnlySpan{ushort}, uint, uint)"/>
            [MethodImpl(AggressiveInlining)]
            public void ForParallel<T0, T1>(QueryFunction<T0, T1> function,
                                            EntityStatusType entities = EntityStatusType.Enabled,
                                            ComponentStatus components = ComponentStatus.Enabled,
                                            ReadOnlySpan<ushort> clusters = default,
                                            uint minEntitiesPerThread = Const.ENTITIES_IN_SEGMENT,
                ...
                if (PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&ForParallelInternal<T0, T1, QueryFunctionAdapter<T0, T1>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
            ...
            [MethodImpl(AggressiveInlining)]
            public unsafe void For<T0, T1>(delegate*<ref T0, ref T1, void> function,
                                           EntityStatusType entities = EntityStatusType.Enabled,
                                           ComponentStatus components = ComponentStatus.Enabled,
                                           QueryMode queryMode = QueryMode.Strict,
                                           ReadOnlySpan<ushort> clusters = default)
            ...
            /// <inheritdoc cref="For{T0}(QueryFunctionWithEntity{TWorld,T0}, EntityStatusType, ComponentStatus, QueryMode, ReadOnlySpan{ushort})"/>
            [MethodImpl(AggressiveInlining)]
            public unsafe void For<T0, T1>(delegate*<Entity, ref T0, ref T1, void> function,
                                           EntityStatusType entities = EntityStatusType.Enabled,
                                           ComponentStatus components = ComponentStatus.Enabled,
                                           QueryMode queryMode = QueryMode.Strict,
                                           ReadOnlySpan<ushort> clusters = default)
            ...
            [MethodImpl(AggressiveInlining)]
            public void For<TData, T0, T1>(TData userData,
                                           QueryFunctionWithRefDataEntityR1<TData, TWorld, T0, T1> function,
                                           EntityStatusType entities = EntityStatusType.Enabled,
                                           ComponentStatus components = ComponentStatus.Enabled,
                                           QueryMode queryMode = QueryMode.Strict,
                                           ReadOnlySpan<ushort> clusters = default)
            ...
            /// <inheritdoc cref="ForParallel{TData,T0, T1}(ref TData, QueryFunctionWithRefDataEntityR1{TData,TWorld,T0, T1}, EntityStatusType, ComponentStatus, ReadOnlySpan{ushort}, uint, uint)"/>
            [MethodImpl(AggressiveInlining)]
            public void ForParallel<TData, T0, T1>(ref TData userData,
                                                   QueryFunctionWithRefDataEntityR1<TData, TWorld, T0, T1> function,
                                                   EntityStatusType entities = EntityStatusType.Enabled,
                ...
                if (PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&ForParallelInternal<T0, T1, QueryFunctionWithDataEntityAdapterWrite1Read1<TData, T0, T1>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
            ...
            /// <inheritdoc cref="Search{T0, T1}(out Entity, SearchFunctionWithEntity{TWorld,T0, T1}, EntityStatusType, ComponentStatus, QueryMode, ReadOnlySpan{ushort})"/>
            [MethodImpl(AggressiveInlining)]
            public void For<T0, T1>(QueryFunctionWithEntityR1<TWorld, T0, T1> function,
                                    EntityStatusType entities = EntityStatusType.Enabled,
                                    ComponentStatus components = ComponentStatus.Enabled,
                                    QueryMode queryMode = QueryMode.Strict,
                                    ReadOnlySpan<ushort> clusters = default)
            ...
            /// <inheritdoc cref="ForParallel{T0, T1}(QueryFunctionWithEntityR1{TWorld,T0, T1}, EntityStatusType, ComponentStatus, ReadOnlySpan{ushort}, uint, uint)"/>
            [MethodImpl(AggressiveInlining)]
            public void ForParallel<T0, T1>(QueryFunctionWithEntityR1<TWorld, T0, T1> function,
                                            EntityStatusType entities = EntityStatusType.Enabled,
                                            ComponentStatus components = ComponentStatus.Enabled,
                                            ReadOnlySpan<ushort> clusters = default,
                                            uint minEntitiesPerThread = Const.ENTITIES_IN_SEGMENT,
                ...
                if (PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&ForParallelInternal<T0, T1, QueryFunctionWithEntityAdapterWrite1Read1<T0, T1>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
            ...
            [MethodImpl(AggressiveInlining)]
            public void For<TData, T0, T1>(TData userData,
                                           QueryFunctionWithRefDataR1<TData, T0, T1> function,
                                           EntityStatusType entities = EntityStatusType.Enabled,
                                           ComponentStatus components = ComponentStatus.Enabled,
                                           QueryMode queryMode = QueryMode.Strict,
                                           ReadOnlySpan<ushort> clusters = default)
            ...
            /// <inheritdoc cref="ForParallel{TData,T0, T1}(ref TData, QueryFunctionWithRefDataR1{TData,TWorld,T0, T1}, EntityStatusType, ComponentStatus, ReadOnlySpan{ushort}, uint, uint)"/>
            [MethodImpl(AggressiveInlining)]
            public void ForParallel<TData, T0, T1>(ref TData userData,
                                                   QueryFunctionWithRefDataR1<TData, T0, T1> function,
                                                   EntityStatusType entities = EntityStatusType.Enabled,
                ...
                if (PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&ForParallelInternal<T0, T1, QueryFunctionWithDataAdapterWrite1Read1<TData, T0, T1>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
            ...
            /// <inheritdoc cref="For{T0}(QueryFunctionWithEntity{TWorld,T0}, EntityStatusType, ComponentStatus, QueryMode, ReadOnlySpan{ushort})"/>
            [MethodImpl(AggressiveInlining)]
            public void For<T0, T1>(QueryFunctionR1<T0, T1> function,
                                    EntityStatusType entities = EntityStatusType.Enabled,
                                    ComponentStatus components = ComponentStatus.Enabled,
                                    QueryMode queryMode = QueryMode.Strict,
                                    ReadOnlySpan<ushort> clusters = default)
            ...
            /// <inheritdoc cref="ForParallel{T0, T1}(QueryFunctionR1{T0, T1}, EntityStatusType, ComponentStatus, ReadOnlySpan{ushort}, uint, uint)"/>
            [MethodImpl(AggressiveInlining)]
            public void ForParallel<T0, T1>(QueryFunctionR1<T0, T1> function,
                                            EntityStatusType entities = EntityStatusType.Enabled,
                                            ComponentStatus components = ComponentStatus.Enabled,
                                            ReadOnlySpan<ushort> clusters = default,
                                            uint minEntitiesPerThread = Const.ENTITIES_IN_SEGMENT,
                ...
                if (PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&ForParallelInternal<T0, T1, QueryFunctionAdapterWrite1Read1<T0, T1>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
            ...
            [MethodImpl(AggressiveInlining)]
            public void For<TData, T0, T1>(TData userData,
                                           QueryFunctionWithRefDataEntityR2<TData, TWorld, T0, T1> function,
                                           EntityStatusType entities = EntityStatusType.Enabled,
                                           ComponentStatus components = ComponentStatus.Enabled,
                                           QueryMode queryMode = QueryMode.Strict,
                                           ReadOnlySpan<ushort> clusters = default)
                ...
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
                QueryFunctionWithDataEntityAdapterRead<TData, T0, T1> adapter;
                adapter.Function = function;
                adapter.UserData = userData;
                ForInternal<T0, T1, QueryFunctionWithDataEntityAdapterRead<TData, T0, T1>>(ref adapter,
                    entities, components, queryMode, clusters);
            }
            ...
            /// <inheritdoc cref="ForParallel{TData,T0, T1}(ref TData, QueryFunctionWithRefDataEntityR2{TData,TWorld,T0, T1}, EntityStatusType, ComponentStatus, ReadOnlySpan{ushort}, uint, uint)"/>
            [MethodImpl(AggressiveInlining)]
            public void ForParallel<TData, T0, T1>(ref TData userData,
                                                   QueryFunctionWithRefDataEntityR2<TData, TWorld, T0, T1> function,
                                                   EntityStatusType entities = EntityStatusType.Enabled,
                ...
                if (PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&ForParallelInternal<T0, T1, QueryFunctionWithDataEntityAdapterRead<TData, T0, T1>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
            ...
            /// <inheritdoc cref="Search{T0, T1}(out Entity, SearchFunctionWithEntity{TWorld,T0, T1}, EntityStatusType, ComponentStatus, QueryMode, ReadOnlySpan{ushort})"/>
            [MethodImpl(AggressiveInlining)]
            public void For<T0, T1>(QueryFunctionWithEntityR2<TWorld, T0, T1> function,
                                    EntityStatusType entities = EntityStatusType.Enabled,
                                    ComponentStatus components = ComponentStatus.Enabled,
                                    QueryMode queryMode = QueryMode.Strict,
                                    ReadOnlySpan<ushort> clusters = default)
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
                QueryFunctionWithEntityAdapterRead<T0, T1> adapter;
                adapter.Function = function;
                ForInternal<T0, T1, QueryFunctionWithEntityAdapterRead<T0, T1>>(ref adapter,
                    entities, components, queryMode, clusters);
            }
            
            /// <inheritdoc cref="ForParallel{T0, T1}(QueryFunctionWithEntityR2{TWorld,T0, T1}, EntityStatusType, ComponentStatus, ReadOnlySpan{ushort}, uint, uint)"/>
            [MethodImpl(AggressiveInlining)]
            public void ForParallel<T0, T1>(QueryFunctionWithEntityR2<TWorld, T0, T1> function,
                                            EntityStatusType entities = EntityStatusType.Enabled,
                                            ComponentStatus components = ComponentStatus.Enabled,
                                            ReadOnlySpan<ushort> clusters = default,
                                            uint minEntitiesPerThread = Const.ENTITIES_IN_SEGMENT,
                ...
                if (PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&ForParallelInternal<T0, T1, QueryFunctionWithEntityAdapterRead<T0, T1>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
            ...
            [MethodImpl(AggressiveInlining)]
            public void For<TData, T0, T1>(TData userData,
                                           QueryFunctionWithRefDataR2<TData, T0, T1> function,
                                           EntityStatusType entities = EntityStatusType.Enabled,
                                           ComponentStatus components = ComponentStatus.Enabled,
                                           QueryMode queryMode = QueryMode.Strict,
                                           ReadOnlySpan<ushort> clusters = default)
                ...
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
                QueryFunctionWithDataAdapterRead<TData, T0, T1> adapter;
                adapter.Function = function;
                adapter.UserData = userData;
                ForInternal<T0, T1, QueryFunctionWithDataAdapterRead<TData, T0, T1>>(ref adapter,
                    entities, components, queryMode, clusters);
            }
            ...
            /// <inheritdoc cref="ForParallel{TData,T0, T1}(ref TData, QueryFunctionWithRefDataR2{TData,TWorld,T0, T1}, EntityStatusType, ComponentStatus, ReadOnlySpan{ushort}, uint, uint)"/>
            [MethodImpl(AggressiveInlining)]
            public void ForParallel<TData, T0, T1>(ref TData userData,
                                                   QueryFunctionWithRefDataR2<TData, T0, T1> function,
                                                   EntityStatusType entities = EntityStatusType.Enabled,
                ...
                if (PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&ForParallelInternal<T0, T1, QueryFunctionWithDataAdapterRead<TData, T0, T1>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
            ...
            /// <inheritdoc cref="For{T0}(QueryFunctionWithEntity{TWorld,T0}, EntityStatusType, ComponentStatus, QueryMode, ReadOnlySpan{ushort})"/>
            [MethodImpl(AggressiveInlining)]
            public void For<T0, T1>(QueryFunctionR2<T0, T1> function,
                                    EntityStatusType entities = EntityStatusType.Enabled,
                                    ComponentStatus components = ComponentStatus.Enabled,
                                    QueryMode queryMode = QueryMode.Strict,
                                    ReadOnlySpan<ushort> clusters = default)
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
                QueryFunctionAdapterRead<T0, T1> adapter;
                adapter.Function = function;
                ForInternal<T0, T1, QueryFunctionAdapterRead<T0, T1>>(ref adapter,
                    entities, components, queryMode, clusters);
            }
            
            /// <inheritdoc cref="ForParallel{T0, T1}(QueryFunctionR2{T0, T1}, EntityStatusType, ComponentStatus, ReadOnlySpan{ushort}, uint, uint)"/>
            [MethodImpl(AggressiveInlining)]
            public void ForParallel<T0, T1>(QueryFunctionR2<T0, T1> function,
                                            EntityStatusType entities = EntityStatusType.Enabled,
                                            ComponentStatus components = ComponentStatus.Enabled,
                                            ReadOnlySpan<ushort> clusters = default,
                                            uint minEntitiesPerThread = Const.ENTITIES_IN_SEGMENT,
                ...
                if (PrepareParallel<T0, T1>(Filter, clusters, entities, components, out var count, out var jobs, out var jobIndexes)) {
                    ...
                    {
                        unsafe {
                            ParallelRunner<TWorld>.Run(&ForParallelInternal<T0, T1, QueryFunctionAdapterRead<T0, T1>>,
                                jobs, jobIndexes, count, Math.Max(minEntitiesPerThread / Const.ENTITIES_IN_SEGMENT, 1), workersLimit
                            );
                        }
                    }
            ...
            #region BLOCKS
            [MethodImpl(AggressiveInlining)]
            public unsafe void ForBlock<T0, T1>(delegate*<uint, EntityBlock, Block<T0>, Block<T1>, void> function,
                                                EntityStatusType entities = EntityStatusType.Enabled,
                                                ComponentStatus components = ComponentStatus.Enabled,
                                                ReadOnlySpan<ushort> clusters = default)
                where T0 : unmanaged, IComponent
            ...
            [MethodImpl(AggressiveInlining)]
            internal unsafe void ForBlockInternal<T0, T1, TAdapter>(ref TAdapter adapter,
            ...
            #if !FFS_ECS_DISABLE_CHANGED_TRACKING
            [MethodImpl(AggressiveInlining)]
            internal unsafe void ForBlockInternal<T0, T1, TAdapter, TTracker>(ref TAdapter adapter,
                TTracker tracker,
                EntityStatusType entities,
                ComponentStatus components,
                ReadOnlySpan<ushort> clusters)
            ...
            [MethodImpl(AggressiveInlining)]
            internal unsafe void ForBlockInternalTracked<T0, T1, TAdapter, TTracker>(ref TAdapter adapter,
                TTracker tracker,
                EntityStatusType entities,
                ComponentStatus components,
                ReadOnlySpan<ushort> clusters)
                ...
                where TTracker : struct, IChangedTracker
            {
                if (tracker.IsActive) {
                    ...
                    ForBlockInternal<T0, T1, TAdapter>(ref adapter, entities, components, clusters);
                }
            }
            #endif


            internal static unsafe void ForBlockParallelInternal<T0, T1, TAdapter>(Job[] jobs, uint[] jobIndexes, uint from, uint to, int worker)
                where T0 : unmanaged, IComponent
                where T1 : unmanaged, IComponent
                where TAdapter : struct, IBlockQueryAdapter<T0, T1> {
                ref var world = ref Data.Instance;
            ...
            [MethodImpl(AggressiveInlining)]
            internal void ForInternalFlexible<T0, T1, TFunction>(ref TFunction function,
                                                                 EntityStatusType entities = EntityStatusType.Enabled,
                                                                 ComponentStatus components = ComponentStatus.Enabled,
                                                                 ReadOnlySpan<ushort> clusters = default)
                where T0 : struct, IComponent
                        ...
                        do {
                            ...
                            do {
                                ...
                                do {
                                    ...
                                    Data.Instance.SetCurrentQueryEntity(entityId);
                                    #endif
                                    function.Invoke(entity, ref comp0[idx], ref comp1[idx]);
                                    isolatedBit <<= 1;
                                    idx++;
                                    entityId++;
                                } while ((entitiesMaskRef & isolatedBit) != 0);
            ...
            [MethodImpl(AggressiveInlining)]
            internal void ForInternalStrict<T0, T1, TFunction>(ref TFunction function,
                                                               EntityStatusType entities = EntityStatusType.Enabled,
                                                               ComponentStatus components = ComponentStatus.Enabled,
                                                               ReadOnlySpan<ushort> clusters = default)
                where T0 : struct, IComponent
                        ...
                        do {
                            ...
                            if (entitiesMask == ulong.MaxValue) {
                                ...
                                while (componentOffset < componentEnd) {
                                    ...
                                    Data.Instance.SetCurrentQueryEntity(entityId);
                                    #endif
                                    function.Invoke(entity, ref comp0[componentOffset], ref comp1[componentOffset]);
                                    componentOffset++;
                                    entityId++;
                                }
                                #else
                                function.InvokeBlock(entity, componentOffset, componentEnd, comp0, comp1);
                                #endif
                            }
                            else {
                                var runStarts = entitiesMask & ~(entitiesMask << 1);
                                ...
                                do {
                                    ...
                                    while (componentIdx <= componentEnd) {
                                        ...
                                        Data.Instance.SetCurrentQueryEntity(entityId);
                                        #endif
                                        function.Invoke(entity, ref comp0[componentIdx], ref comp1[componentIdx]);
                                        componentIdx++;
                                        entityId++;
                                    }
                                    #else
                                    function.InvokeBlock(entity, componentIdx, componentEnd + 1, comp0, comp1);
                                    #endif
                                } while (runStarts != 0);
                            }
                        } while (firstGlobalBlockIdx >= 0);
            ...
            #if !FFS_ECS_DISABLE_CHANGED_TRACKING
            [MethodImpl(AggressiveInlining)]
            internal void ForInternalFlexible<T0, T1, TFunction, TTracker>(ref TFunction function,
                                                                           TTracker tracker,
                                                                           EntityStatusType entities = EntityStatusType.Enabled,
                                                                           ComponentStatus components = ComponentStatus.Enabled,
                                                                           ReadOnlySpan<ushort> clusters = default)
            ...
            [MethodImpl(AggressiveInlining)]
            internal void ForInternalStrict<T0, T1, TFunction, TTracker>(ref TFunction function,
                                                                         TTracker tracker,
                                                                         EntityStatusType entities = EntityStatusType.Enabled,
                                                                         ComponentStatus components = ComponentStatus.Enabled,
                                                                         ReadOnlySpan<ushort> clusters = default)
            ...
            [MethodImpl(AggressiveInlining)]
            internal void ForInternalTracked<T0, T1, TFunction, TTracker>(ref TFunction function,
                TTracker tracker,
                EntityStatusType entities = EntityStatusType.Enabled,
                ComponentStatus components = ComponentStatus.Enabled,
                QueryMode queryMode = QueryMode.Strict,
                ...
                where TTracker : struct, IChangedTracker
            {
                if (tracker.IsActive) {
                    if (queryMode == QueryMode.Strict) {
                        ForInternalStrict<T0, T1, TFunction, TTracker>(ref function, tracker, entities, components, clusters);
                    }
                    else {
                        ForInternalFlexible<T0, T1, TFunction, TTracker>(ref function, tracker, entities, components, clusters);
                    }
                } else {
                    if (queryMode == QueryMode.Strict) {
                        ForInternalStrict<T0, T1, TFunction>(ref function, entities, components, clusters);
                    }
                    else {
                        ForInternalFlexible<T0, T1, TFunction>(ref function, entities, components, clusters);
                    }
                }
            }
            #endif
            ...
            [MethodImpl(AggressiveInlining)]
            internal void ForInternal<T0, T1, TFunction>(ref TFunction function,
                                                             EntityStatusType entities = EntityStatusType.Enabled,
                                                             ComponentStatus components = ComponentStatus.Enabled,
                                                             QueryMode queryMode = QueryMode.Strict,
                                                             ReadOnlySpan<ushort> clusters = default)
            ...
            internal static unsafe void ForParallelInternal<T0, T1, TFunction>(Job[] jobs, uint[] jobIndexes, uint from, uint to, int worker)
                where T0 : struct, IComponent
                where T1 : struct, IComponent
                where TFunction : struct, IQueryFunctionAdapter<T0, T1> {
                var segments0 = Components<T0>.Instance.ComponentSegments;
            ...
            [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
            [MethodImpl(AggressiveInlining)]
            internal unsafe bool PrepareParallel<T0, T1>(TFilter filter, ReadOnlySpan<ushort> clusters,
                                                         EntityStatusType entities,
                                                         ComponentStatus components,
            ...
            [MethodImpl(AggressiveInlining)]
            internal void DisposeFlexible<T0, T1>(TFilter filter, EntityStatusType entities, ComponentStatus components, QueryData queryData)
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
                ref var world = ref Data.Instance;
                ref var pool0 = ref Components<T0>.Instance;
            ...
            #if FFS_ECS_DEBUG
            [MethodImpl(AggressiveInlining)]
            internal void DisposeStrict<T0, T1>(TFilter filter, EntityStatusType entities, ComponentStatus components, QueryData queryData)
                where T0 : struct, IComponent
                where T1 : struct, IComponent {
